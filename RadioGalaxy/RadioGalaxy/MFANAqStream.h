...
//
// MFANAqStream owns the RadioStream stream thread and an MFANAqStreamBuffer
...
// continue reading already-streamed data.
//
// When -shutdown is called the stream thread is stopped, the audio-stream
// parser is closed, and buffer.streamComplete is set to YES so that readers
...
// MFANAqStream
//
// Streams a radio stream from a URL, parses the incoming AAC/MP3 data, and
...
// YES once shutdown has been initiated on the streamer.
